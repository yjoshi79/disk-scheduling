...
import "./LOOKSim.css";  // Import the LOOK-specific CSS
...
const LOOKSim = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (direction === "left") {
      // Move left first, then go to right
      sequence = [...left, ...right];
    } else {
      // Move right first, then go to left
      sequence = [...right, ...left];
    }
  ...
  return (
    <>
      ...
      <div className="look-container">
        <h2>LOOK Disk Scheduling Simulation</h2>
        <form onSubmit={handleSubmit} className="look-form">
