...
import "./SCANSim.css";  // Import the SCAN-specific CSS
...
const SCANSim = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const directionFlag = direction === "left" ? "left" : "right";
    const sequence = directionFlag === "left" 
      ? [headStart, ...sortedRequests.filter(r => r <= headStart).reverse(), ...sortedRequests.filter(r => r > headStart)] 
      : [...sortedRequests.filter(r => r <= headStart), headStart, ...sortedRequests.filter(r => r > headStart)];
  ...
  return (
    <>
      ...
      <div className="scan-container">
        <h2>SCAN Disk Scheduling Simulation</h2>
        <form onSubmit={handleSubmit} className="scan-form">
          ...
          <label>Enter Direction (left/right):</label>
          <input
            type="text"
            value={direction}
