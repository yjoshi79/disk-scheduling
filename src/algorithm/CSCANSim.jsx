...
import "./CSCANSim.css";  // Import the CSCAN-specific CSS
...
const CSCANSim = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // CSCAN requires the head to go from one end to the other and then wrap around
    if (direction === "right") {
      sequence = [...right, totalCylinders - 1, ...left];
    } else {
  ...
  return (
    <>
      <Header />
      <div className="cscan-container">
        <h2>CSCAN Disk Scheduling Simulation</h2>
        <form onSubmit={handleSubmit} className="cscan-form">
